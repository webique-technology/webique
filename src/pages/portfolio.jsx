...
//             {
//                 desc: "Showcase Your Project to 10M+ Users",
//                 title: "Om mangalam House keeping",
//                 bntLink: "",
//                 src: omHouse,
//                 extraClass: "",
//                 imgScrollClass: ""
...
grid col and rows structure

// first mansory grid make with row and col bootstrap classes 
<Row className='row-gap-4'>
    {portfolioData.slice(0, visible).map((item, i) => {
        return (
            <Col xs={12} sm={6} md={6} lg={4} key={i} className='d-flex flex-column gap-4'>
                {item.blueBoxData.map((value, index) => {
                    const currentIndex = globalIndex++;
                    return (
                        <div
                            className="blue-box w-100"
                            key={index}
                            onMouseEnter={() => handleMouseEnter(currentIndex)}
                            onMouseLeave={() => handleMouseLeave(currentIndex)}
                        >
